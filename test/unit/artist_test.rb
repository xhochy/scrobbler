...
class TestArtist < Test::Unit::TestCase
  ...
  def setup
    ...
    @similar_artists = ["Megadeth", "Pantera", "Slayer", "Iron Maiden", 
        "Anthrax", "Machine Head", "Sepultura", "Mot\303\266rhead", "Testament",
        ...
        "Rammstein", "Ko\320\257n", "Death Angel", "In Flames", "Lamb of God",
        "Overkill", "Diamond Head", "Damageplan", "Acid Drinkers", "Beatallica",
        "Stone Sour", "Metal Church", "MD.45", "Volbeat", "HammerFall", 
        "Black Tide", "Rage Against the Machine", "Manowar", "Probot",
        "Bullet For My Valentine", "Flotsam and Jetsam", "Dio", 
        "Roadrunner United", "Venom", "Arch Enemy", "Mercyful Fate", 
        "Nuclear Assault", "Destruction", "Blind Guardian", "Sacred Reich",
        "Bruce Dickinson", "Turbo", "Static-X", "Helloween", "Zakk Wylde",
        "Avenged Sevenfold", "W.A.S.P.", "Kat", "Skid Row", "DevilDriver",
        "Danzig", "Heathen", "Mokoma", "Lordi", "Shadows Fall", "Chimaira",
        "Whiplash", "Mudvayne","Onslaught", "Sodom", "Rage", "Forbidden", 
        "Evile", "Savatage", "Scorpions", "DragonForce", "Axel Rudi Pell",
        "Rob Zombie", "Killswitch Engage", "Sebastian Bach", "Saxon", 
        "Cavalera Conspiracy", "Voivod", "Drowning Pool", "Fear Factory",
        "M\303\266tley Cr\303\274e", "Prong", "Kotiteollisuus", "Stone",
