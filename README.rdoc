...
I (kschrader) am currently updating it to use the 2.0 API. It is very much a work in progress.
Right now you can use the new 2.0 search capabilities to find artists, albums, and tracks.
